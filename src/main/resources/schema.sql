...
-- Piste d'audit infalsifiable : interdit toute modification ou suppression
-- sur la table d'audit une fois une ligne insérée (3.7 du dossier).
REVOKE UPDATE, DELETE ON audit_referentiel FROM PUBLIC;
