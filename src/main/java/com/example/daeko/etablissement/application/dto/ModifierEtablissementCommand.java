...
public class ModifierEtablissementCommand {
    ...
    public ModifierEtablissementCommand(UUID id, String nomOfficiel, String nomOfficielEn,
                                        String sigle, StatutJuridique statutJuridique,
                                        String numeroAgrement, String codeEtablissement,
                                        String devisePropre, UUID regionId, UUID departementId,
                                        UUID arrondissementId, String ville, String boitePostale,
                                        String telephones, String email, String siteWeb,
                                        UUID utilisateurId) {
        this.id = id;
