...
public class CycleController {
    ...
    public CycleResponse modifier(
        ...
        return cycleMapper.toResponse(cycleUseCase.modifier(cycleMapper.toCommand(id, request, null)));
    }
    ...
    public CycleResponse reactiver(@PathVariable UUID id) {
        ReactiverCommand command = new ReactiverCommand(id, null);
        return cycleMapper.toResponse(cycleUseCase.reactiver(command));
    }
