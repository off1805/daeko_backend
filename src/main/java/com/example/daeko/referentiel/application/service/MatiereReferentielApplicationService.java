...
@Service
public class MatiereReferentielApplicationService
    ...
    @Override
    @Transactional
    @CacheEvict(value = CacheConfig.CACHE_MATIERES, allEntries = true)
    ...
    @Override
    @Cacheable(value = CacheConfig.CACHE_MATIERES, key = "#id")
    ...
    @Override
    @Cacheable(value = CacheConfig.CACHE_MATIERES, key = "#etat")
