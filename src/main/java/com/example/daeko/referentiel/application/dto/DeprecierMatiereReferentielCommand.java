...
public class DeprecierMatiereReferentielCommand {
    ...
    public DeprecierMatiereReferentielCommand(UUID entiteId, String motif, LocalDate dateEffet, UUID utilisateurId) {
